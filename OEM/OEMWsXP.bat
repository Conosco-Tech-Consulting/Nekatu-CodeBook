...
set BUILDNO=%USERDOMAIN%WS%DATE2%XP
...
ECHO SubModel=Joskos Solutions Workstation >> %systemroot%\system32\OEMINFO.INI
...
copy %systemroot%\system32\oem\oemlogo.bmp %systemroot%\system32 /y
copy %systemroot%\system32\oem\joskos.ico %systemroot%\system32 /y

regedit /s %systemroot%\system32\oem\WSPatch.reg