...
$AdminURI = "https://fossewayschool-admin.sharepoint.com"
# Specify the User account for an Office 365 global admin in your organization
$AdminAccount = "joskos@fossewayschool.com"
$AdminPass = "TPT4dm2k!"

# Specify the secondary admin account and the url for the onedrive site
$secondaryadmin = "joskos@fossewayschool.com"
$siteURI = "https://fossewayschool-my.sharepoint.com" 
