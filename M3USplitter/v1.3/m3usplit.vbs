...
While Not objFile.AtEndOfStream
	...
	If strplaylistTitle <> strCurrentplaylist Then
		...
		Set objplaylist = objFSO.CreateTextFile("playlist" & wscript.arguments(1) & ".tmp", True)
		objplaylist.WriteLine strLine
		objplaylist.Close
		Set objplaylist = Nothing
	Else
		Set objplaylist = objFSO.OpenTextFile("playlist" & wscript.arguments(1) & ".tmp", intForAppending, False)
		objplaylist.WriteLine strLine
		objplaylist.Close
		Set objplaylist = Nothing		
	End If
