...
Dim ZipHex, ZipBinary, ZipSourcePrompt, ZipSourceQuestion, ZipSource
Dim ZipTargetPrompt, ZipTargetQuestion, ZipTarget
Dim oShell, oApp, oFolder, oCTF, oFile, i
Dim oFileSys

' Specify Source
ZipSourcePrompt = "Please specify the folder you wish to compress"
ZipSourceQuestion = "e.g. C:\Images"
ZipSource = InputBox(ZipSourceQuestion, ZipSourcePrompt)

' Specify Source
ZipTargetPrompt = "Please specify the .zip file you wish to create"
ZipTargetQuestion = "e.g. C:\images.zip"
ZipTarget = InputBox(ZipTargetQuestion, ZipTargetPrompt)
